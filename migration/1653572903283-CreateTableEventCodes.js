module.exports = class CreateTableEventCodes1653572903283 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`event_codes\` ADD CONSTRAINT \`FK_863e8b745d1f07767bcce34b38d\` FOREIGN KEY (\`event_id\`) REFERENCES \`events\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
